 ...
 */
final class Version20240909171757 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salary_report CHANGE paid_salary_amount paid_salary_amount DOUBLE PRECISION DEFAULT NULL, CHANGE remaining_salary_amount remaining_salary_amount DOUBLE PRECISION DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salary_report CHANGE paid_salary_amount paid_salary_amount DOUBLE PRECISION NOT NULL, CHANGE remaining_salary_amount remaining_salary_amount DOUBLE PRECISION NOT NULL');
    }
}
